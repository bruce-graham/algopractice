...
describe('allPermutations', function () {
  ...
  it('exists', function () {
    expect(allPermutations).to.be.a('function');
  });

  it('should return an array with all permutations of a string with unique characters', () => {
    expect(allPermutations('ABC')).to.deep.equal(['ABC', 'ACB', 'BAC', 'BCA', 'CAB', 'CBA']);
    // expect(allPermutations([[12,[[34],[56]],78]])).to.equal(180);
    // expect(allPermutations([3,[0,[34,[7,[18]]]]])).to.equal(62);
  });
}); //arraySum